...
CREATE TABLE `portfolio` (
  ...
  KEY `FKE8F5152815302235` (`OWNER_ID`),
  CONSTRAINT `FKE8F5152815302235` FOREIGN KEY (`OWNER_ID`) REFERENCES `users` (`USER_ID`)
...
INSERT INTO `portfolio` VALUES (1,'Default',0,1),(2,'Default',0,50);
